    ...
    class ReduxFramework_icon_select extends ReduxFramework_extension_icon_select {
        ...
        function __construct( $field = array(), $value ='', $parent ) {
            ...
            if ( empty( $this->field['options'] ) && empty( $this->field['stylesheet'] ) ) {
                ...
                $this->field['stylesheet'] = ELEMENT_URI . '/resources/styles/css/vendor/font-awesome.min.css';
                //$this->field['stylesheet'] = ReduxFramework::$_dir.'assets/css/vendor/elusive-icons/elusive-icons.css';
                $this->field['enqueue'] = true;
                $this->field['enqueue_frontend'] = false;
            ...
            if( !empty( $this->field['options'] ) ) {
                ...
                echo '<div class="redux-icon-container" style="' . $style . '">';
                    ...
                    foreach( $this->field['options'] as $k => $v ) {
                        ...
                        echo '<input type="radio" class="' . $this->field['class'] . '" id="' . $this->field['id'] . '_' . $k . '" name="' . $this->field['name'] . '" value="' . $k . '" ' . checked( $this->value, $k, false ) . '/>';
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                ...
                $this->extension_url . 'field_icon_select.js', 
                array( 'jquery' ),
                time(),
                true
            );
